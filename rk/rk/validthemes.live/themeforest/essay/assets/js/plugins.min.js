...
*/
!function(n){n.fn.jaliswall=function(i){return this.each(function(){function t(){var n=!1;0==d.find(l.columnClass).length&&(n=!0,d.append("<div class='"+r(l.columnClass)+"'></div>"));var i=d.find(l.columnClass).outerWidth(!0),t=d.innerWidth();return n&&d.find(l.columnClass).remove(),Math.round(t/i)}function e(){f.each(function(i){var t=n(this);u.push({content:t.html(),class:t.attr("class"),href:t.attr("href"),id:t.attr("id"),colid:i%h}),t.remove()})}function s(){for(var n in u)u[n].colid=n%h}function r(n){return n.slice(1,n.length)}function a(){for(var n="",i=0;i<h;i++)n+="<div class='"+r(l.columnClass)+"'></div>";d.html(n);for(var i in u){var t="",e=void 0!=u[i].content?u[i].content:"",s=u[i].href!=s?u[i].href:"",a=void 0!=u[i].class?u[i].class:"",o=void 0!=u[i].id?u[i].id:"";void 0!=u[i].href?t+="<a "+c(s,"href")+" "+c(a,"class")+" "+c(o,"id")+">"+e+"</a>":t+="<div "+c(a,"class")+" "+c(o,"id")+">"+e+"</a>",d.children(l.columnClass).eq(i%h).append(t)}}function c(n,i){return void 0!=n?i+"='"+n+"'":""}var o={item:".single-blog-item",columnClass:".pf-colum",resize:!1},l=n.extend(o,i),d=n(this),f=d.find(l.item),u=[],h=t();h=t(),f.each(function(i){var t=n(this);u.push({content:t.html(),class:t.attr("class"),href:t.attr("href"),id:t.attr("id"),colid:i%h}),t.remove()}),a(),l.resize&&n(window).resize(function(){h!=t()&&(h=t(),s(),a())})}),this}}(jQuery);
...
/* -----------------------------------------------
/* Esham Main JS
/* Author : Md Sohag  - validtheme.com
/* v2.0.0
/* ----------------------------------------------- */
!function(e){"use strict";e(document).on("ready",function(){new WOW({boxClass:"wow",animateClass:"animated",offset:0,mobile:!0,live:!0}).init(),e("body").scrollspy({target:".navbar-collapse",offset:200}),e("a.smooth-menu").on("click",function(a){var t=e(this);e("html, body").stop().animate({scrollTop:e(t.attr("href")).offset().top-"75"+"px"},1500,"easeInOutExpo"),a.preventDefault()}),e(".element").typed({strings:["Professional Web Developer","WordPress Expert","Laravel Expert"],typeSpeed:10,loop:!0,backDelay:2e3}),e(".player").mb_YTPlayer();var a=e("#particles-js");a.addClass("partIn"),1==a.hasClass("partIn")&&particlesJS("particles-js",{particles:{number:{value:80,density:{enable:!0,value_area:800}},color:{value:"#ffffff"},shape:{type:"circle",stroke:{width:0,color:"#000000"},polygon:{nb_sides:5},image:{src:"img/github.svg",width:100,height:100}},opacity:{value:.5,random:!1,anim:{enable:!1,speed:1,opacity_min:.1,sync:!1}},size:{value:5,random:!0,anim:{enable:!1,speed:40,size_min:.1,sync:!1}},line_linked:{enable:!0,distance:150,color:"#ffffff",opacity:.4,width:1},move:{enable:!0,speed:6,direction:"none",random:!1,straight:!1,out_mode:"out",attract:{enable:!1,rotateX:600,rotateY:1200}}},interactivity:{detect_on:"canvas",events:{onhover:{enable:!0,mode:"repulse"},onclick:{enable:!0,mode:"push"},resize:!0},modes:{grab:{distance:400,line_linked:{opacity:1}},bubble:{distance:400,size:40,duration:2,opacity:8,speed:3},repulse:{distance:200},push:{particles_nb:4},remove:{particles_nb:2}}},retina_detect:!0,config_demo:{hide_card:!1,background_color:"#b61924",background_image:"",background_position:"50% 50%",background_repeat:"no-repeat",background_size:"cover"}}),e(window).on("resize",function(){e(".equal-height").equalHeights()}),e(".equal-height").equalHeights().find("img, iframe, object").on("load",function(){e(".equal-height").equalHeights()}),e(".masonary").jaliswall({item:".pf-item"}),e(window).on("load",function(){var a=e(".masonary .pf-colum");a.isotope({filter:"*",animationOptions:{duration:750,easing:"linear",queue:!1}}),e(".mix-item-menu a").on("click",function(){e(".mix-item-menu .current").removeClass("current"),e(this).addClass("current");var t=e(this).attr("data-filter");return a.isotope({filter:t,animationOptions:{duration:750,easing:"linear",queue:!1}}),!1})}),e(".popup-link").magnificPopup({type:"image"}),e(".popup-gallery").magnificPopup({type:"image",gallery:{enabled:!0}}),e(".popup-youtube, .popup-vimeo, .popup-gmaps").magnificPopup({disableOn:700,type:"iframe",mainClass:"mfp-fade",removalDelay:160,preloader:!1,fixedContentPos:!1}),e(".magnific-mix-gallery").each(function(){var a=e(this).find(".item"),t=[];a.each(function(){var a=e(this),i="image";a.hasClass("magnific-iframe")&&(i="iframe");var n={src:a.attr("href"),type:i};n.title=a.data("title"),t.push(n)}),a.magnificPopup({mainClass:"mfp-fade",items:t,gallery:{enabled:!0,tPrev:e(this).data("prev-text"),tNext:e(this).data("next-text")},type:"image",callbacks:{beforeOpen:function(){var e=a.index(this.st.el);-1!==e&&this.goTo(e)}}})}),e(".owl-carousel.arrow").owlCarousel({loop:!0,margin:10,nav:!0,dots:!1,navText:["<i class='fa fa-angle-left'></i>","<i class='fa fa-angle-right'></i>"],responsive:{0:{items:1},600:{items:2},1e3:{items:2}}}),e(".timer").countTo(),e(".fun-fact").appear(function(){e(".timer").countTo()},{accY:-100}),e(window).on("load",function(){e(".se-pre-con").fadeOut("slow")}),e(".contact-form").each(function(){e(this).submit(function(){var a=e(this).attr("action");return e("#message").slideUp(750,function(){e("#message").hide(),e("#submit").after('<img src="assets/img/ajax-loader.gif" class="loader" />').attr("disabled","disabled"),e.post(a,{name:e("#name").val(),email:e("#email").val(),phone:e("#phone").val(),comments:e("#comments").val()},function(a){document.getElementById("message").innerHTML=a,e("#message").slideDown("slow"),e(".contact-form img.loader").fadeOut("slow",function(){e(this).remove()}),e("#submit").removeAttr("disabled")})}),!1})})})}(jQuery);
